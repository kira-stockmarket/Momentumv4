...
def main():
    tickers = [
        ...
        "KOTAKBANK.NS", "LT.NS", "LTM.NS", "M&M.NS", "MARICO.NS",
        ...
        "TCS.NS", "TATACONSUM.NS", "TMPV.NS", "TMCV.NS", "TATAPOWER.NS", "TATASTEEL.NS",
        "TECHM.NS", "TITAN.NS", "TORNTPHARM.NS", "TRENT.NS", "ULTRACEMCO.NS",
        "VBL.NS", "VEDL.NS", "WIPRO.NS", "ETERNAL.NS", "ZYDUSLIFE.NS"
    ]
